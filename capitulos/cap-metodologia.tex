...
Para ter uma comunicação confiável entre os dois \gls{ADC}s conectados a fontes diferentes e o ESP32, é necessário o isolamento entre estes, evitando-se curtos. Para isso, foi utilizado um circuito de comunicação isolada por optocouplers, como demonstrado na \autoref{fig:circ-comunic}.
