...
\DocumentTitle{%%
Development of a three-channel multimeter with low cost wireless communication for laboratories at the Universidade Tecnológica Federal do Paraná
}%
...
%% Data da defesa
\Dia{30}%% Dia (opcional: usado na ficha catalográfica apenas)
\MesPorExtenso{maio}%% mês por extenso (opcional: usado na ficha catalográfica apenas)
\Ano{2023}%% Ano
...
\PalavraChaveC{lab}%% Palavra-chave C
...
\KeywordA{multi-meter}%% Keyword A
