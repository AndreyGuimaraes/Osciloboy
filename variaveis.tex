...
\title{Desenvolvimento de um multímetro de três canais com comunicação sem fio de baixo custo para laboratórios da Universidade Tecnológica Federal do Paraná} % Título do trabalho
\titleen{Development of a low cost three-channel multimeter with wireless communication for laboratories at the Federal Technological University of Paraná} % Título traduzido para inglês
