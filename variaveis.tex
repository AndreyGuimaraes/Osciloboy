...
\title{Desenvolvimento de um multímetro modular com comunicação sem fio de baixo custo para laboratórios da Universidade Tecnológica Federal do Paraná} % Título do trabalho
\titleen{Development of a low cost modular multimeter with wireless communication for laboratories at the Federal Technological University of Paraná} % Título traduzido para inglês
...
\evalboardmember{Nastasha Salame da Silva}{Drª}{Universidade Tecnologica Federal do Paraná}
